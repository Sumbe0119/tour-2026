		...
		<section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-sky-50 to-cyan-100 px-4 py-20 sm:px-6 lg:px-8">
			...
			<div className="relative mx-auto max-w-7xl">
				...
				<motion.div
					...
					className="mx-auto mt-12 max-w-5xl rounded-[2rem] border border-cyan-200/80 bg-white/60 px-6 py-7 text-center shadow-xl shadow-cyan-900/10 backdrop-blur"
				>
					<p className="text-lg font-bold leading-8 text-slate-900 sm:text-2xl">
						“Сэтгэл амгалан байвал бодол цэгцэрч, бодол цэгцэрвэл бие
						эрч хүчээр дүүрдэг.”
					</p>
				</motion.div>
			</div>
